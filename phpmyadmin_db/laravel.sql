...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 10 2024 г., 01:46
...
(8, '2024_01_09_123026_create_web_scrap_models_table', 1);
...
--
-- Структура таблицы `web_scrap_models`
--

CREATE TABLE `web_scrap_models` (
  `id` bigint UNSIGNED NOT NULL,
...
--
-- Индексы таблицы `web_scrap_models`
--
ALTER TABLE `web_scrap_models`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `web_scrap_models`
--
ALTER TABLE `web_scrap_models`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
